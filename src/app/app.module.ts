...
import { MdMenuModule, MdIconModule, MdButtonModule, MdSelectModule, MdCheckboxModule, MdCardModule, MdDialogModule } from '@angular/material';
...
@NgModule({
  ...
  imports: [
    ...
    MdMenuModule, MdIconModule, MdButtonModule, MdSelectModule, MdCheckboxModule, MdCardModule, MdDialogModule,
    FlexLayoutModule
  ],
  providers: [],
