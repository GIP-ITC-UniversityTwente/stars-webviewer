...
describe('TimeSeriesBuilderService', () => {
  ...
  it('can create a time series chart data object', inject([TimeSeriesBuilderService], (service: TimeSeriesBuilderService) => {
  ...
  it('can create a time series chart layout object', inject([TimeSeriesBuilderService], (service: TimeSeriesBuilderService) => {
    const actualChartLayout = TimeSeriesBuilderService.createTimeSeriesLayoutObject('Test', 'NDVI Average');
